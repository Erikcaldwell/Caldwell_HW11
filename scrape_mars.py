...
# Creates splinter Browser object and returns browser object instance
def initBrowser():
    return Browser("chrome", headless=False)

#Closes splinter browser object
...
# Getting the weather data from twitter
def marsWeather():
    browser = initBrowser()
